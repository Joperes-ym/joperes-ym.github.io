  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Joana Pereira</h1>
            ...
            <div>
                <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-800 hover:border-pink-800'><Link to="projects" smooth={true} duration={500} >View Projects 
                </Link>
